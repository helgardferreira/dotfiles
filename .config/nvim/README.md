...
| <code>&lt;leader&gt;bk</code> | Close all buffers except current | **n** |
| <code>&lt;leader&gt;bt</code> | Go to buffer (either via number or name) | **n** |
...
| <code>&lt;leader&gt;wx</code> | Close current window split | **n** |
